...
export interface IFileService extends IDisposable {
     ...
     */
    readonly onDidResourceChange: Register<ResourceChangeEvents>;
...
export class FileService extends Disposable implements IFileService {
    ...
    public registerProvider(scheme: string, provider: IFileSystemProvider): void {
        ...
        this.__register(provider.onDidResourceChange(e => this._onDidResourceChange.fire(new ResourceChangeEvents(e))));
