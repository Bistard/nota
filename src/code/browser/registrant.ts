...
registerSingleton(IFolderTreeService, new ServiceDescriptor(FolderTreeService));
registerSingleton(INotebookTreeService, new ServiceDescriptor(NotebookTreeService));
